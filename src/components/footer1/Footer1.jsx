        ...
        <>
             <div className="">
                 <div className="mt-20">
                    ...
                    <div>
                         <img className="m-auto sm:mt-16 mt-10 w-10" src="src/components/footer1/quote-removebg-preview.png" alt="" />
                   ...
                   <div className="flex sm:space-x-5 space-x-3 mt-60 justify-center">
                     <div className="">
                         <img className="imager b1 sm:w-16 sm:h-16 w-14 h-14 rounded-full dark:border-gray-800" src="src/components/footer1/brooklyn.png" alt=""/>
                     </div>
                     <div className="">
                         <img className="imager b2 sm:w-16 sm:h-16 w-14 h-14 rounded-full dark:border-gray-800" src="src/components/footer1/james.png" alt=""/>
                     </div>
                     <div className="">
                         <img className="imager b3 sm:w-16 sm:h-16 w-14 h-14 rounded-full dark:border-gray-800" src="src/components/footer1/robert.png" alt=""/>
                     </div>
                     <div className=""> 
                         <img className="imager b4 sm:w-16 sm:h-16 w-14 h-14 rounded-full dark:border-gray-800" src="src/components/footer1/micheal.png" alt=""/>
                     </div>
                     <div className="">
                         <img className="imager b5 sm:w-16 sm:h-16 w-14 h-14 rounded-full dark:border-gray-800" src="src/components/footer1/Be.png" alt=""/>
                     </div>
                       </div>
             </div>
        </>
